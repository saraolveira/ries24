...
const RIES16 = () => {
    ...
    const links = {
        links: [
            {
                href: "https://forumries.com/blog/docs/RIES2016_memoria.pdf",
                text: "menu.report",
            },
            {
                href: "https://forumries.com/blog/galeria-ediciones-anteriores/#ries2016",
                text: "menu.gallery",
            },
        ],
    }
    ...
    const links16 = linksMap.map((link, i) => {
        return (
            <a
                href={link.href}
                target="_blank"
